package br.edu.usj.programacaoweb.calculadora;
...
public class Calculadora {
    ...
    public ModelAndView resultado(@RequestParam Double numero1,@RequestParam Double numero2, @RequestParam String operacao) 
    {
